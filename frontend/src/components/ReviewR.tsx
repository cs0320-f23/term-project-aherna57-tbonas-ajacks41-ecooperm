 ...
 * time ago text, user name, star ratings, review text, and an optional review image. Each review is presented within a wrapper container, 
 * providing a visually organized and informative representation of user reviews. 
 * The overall purpose of the file is to display reviews in a visually appealing manner. */
...
const Review = () => {
  // Function to handle the deletion of a review based on its index
